...
# bash <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/soarpkgs/refs/heads/main/scripts/sbuild_creator.sh")
# bash <(curl -qfsSL "https://l.ajam.dev/sbuild-creator")
#-------------------------------------------------------#
...
##Enable Debug 
 ...
 SBG_VERSION="0.0.2" && echo -e "[+] SBUILD Generator Version: ${SBG_VERSION}" ; unset SBG_VERSION
#-------------------------------------------------------#
